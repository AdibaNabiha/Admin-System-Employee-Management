    ...
    <div class="col-xl-4">
      ...
      <div class="card">
        ...
        h2 {
          ...
          <h2><?php echo e(session()->get('user')->name); ?></h2>
          <h3><?php echo e(session()->get('user')->position); ?></h3>
      ...
      <div class="tab-content pt-2">
        ...
        <div id="app">
          ...
          <div class="row">
            ...
            <div class="col-lg-9 col-md-8"><?php echo e(session()->get('user')->name); ?></div>
          </div>

          <div class="row">
            <div class="col-lg-3 col-md-4 label">Email</div>
            <div class="col-lg-9 col-md-8"><?php echo e(session()->get('user')->email); ?></div>
          </div>

          <div class="row">
            <div class="col-lg-3 col-md-4 label">Gender</div>
            <div class="col-lg-9 col-md-8"><?php echo e(session()->get('user')->gender); ?></div>
          </div>

          <div class="row">
            <div class="col-lg-3 col-md-4 label">Date of Birth</div>
            <div class="col-lg-9 col-md-8"><?php echo e(session()->get('user')->dob); ?></div>
          </div>

          <div class="row">
            <div class="col-lg-3 col-md-4 label">Address</div>
            <div class="col-lg-9 col-md-8"><?php echo e(session()->get('user')->address); ?></div>
          </div>

          <div class="row">
            <div class="col-lg-3 col-md-4 label">Phone</div>
            <div class="col-lg-9 col-md-8"><?php echo e(session()->get('user')->phone); ?></div>
          </div>

          <div class="row">
            <div class="col-lg-3 col-md-4 label">Position</div>
            <div class="col-lg-9 col-md-8"><?php echo e(session()->get('user')->position); ?></div>
          </div>

          <div class="row">
            <div class="col-lg-3 col-md-4 label">Created Date</div>
            <div class="col-lg-9 col-md-8"><?php echo e(session()->get('user')->created_at ? date('D, d F Y',strtotime($user->created_at)) : 'N/A'); ?></div>
          </div>

          <div class="row">
            <div class="col-lg-3 col-md-4 label">Updated Date</div>
            <div class="col-lg-9 col-md-8"><?php echo e(session()->get('user')->updated_at ? date('D, d F Y',strtotime($user->updated_at)) : 'N/A'); ?></div>
          </div>
        ...
        <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
          ...
          <!-- Profile Edit Form -->
          <form class="row g-3"  action ="userprofile?rid=<?php echo e(session()->get('user')->id); ?>" method="post" enctype="multipart/form-data">
          <?php echo csrf_field(); ?>   
             
            <div class="row mb-3">
              <label  class="col-md-4 col-lg-3 col-form-label">Full Name</label>
              <div class="col-md-8 col-lg-9">
                <input name="fullname" type="text" class="form-control" placeholder="Full Name" value="<?php echo e(session()->get('user')->name); ?>"  required>
              </div>
            </div>
            ...
            <div class="row mb-3">
              ...
              <div class="col-md-8 col-lg-9">
                <input type="password" class="form-control" id="myInput" name="password" value="<?php echo e($user->password); ?>" >
            ...
            <label  class="col-md-4 col-lg-3 col-form-label">Email</label>
              ...
              <span class="input-group-text" id="inputGroupPrepend">@</span>
                <input name="email" type="email" class="form-control" placeholder="Email" value="<?php echo e(session()->get('user')->email); ?>" required>
              </div>  
              </div>
            </div>
            ...
            <div class="row mb-3">
             <label class="col-md-4 col-lg-3 col-form-label">Date of Birth</label>
              <div class="col-md-8 col-lg-9">
              <input class="form-control" type="date" name="dob" value="<?php echo e(session()->get('user')->dob); ?>">
              </div>
            </div>
            ...
            <div class="row mb-3">
              ...
              <div class="col-md-8 col-lg-9">
              <textarea class="form-control" type="text" name="address" required><?php echo e(session()->get('user')->address); ?></textarea>
              </div>
            </div>
            ...
            <div class="row mb-3">
              ...
              <div class="col-md-8 col-lg-9">
              <input type="text" class="form-control" name="phone" value="<?php echo e(session()->get('user')->phone); ?>" required>
              </div>
            </div>
            ...
            <div class="row mb-3">
              ...
              <div class="col-md-8 col-lg-9">
              <input type="text"  class="form-control" name="position" value="<?php echo e(session()->get('user')->position); ?>" required>
              </div>
            </div>
...
<?php echo e(View:: make('footer')); ?><?php /**PATH C:\xampp\htdocs\final-project\resources\views/userprofile.blade.php ENDPATH**/ ?>