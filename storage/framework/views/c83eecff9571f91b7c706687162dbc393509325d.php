...
<div class="pagetitle">
  ...
  <nav>
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item "><a href="/jobs">Jobs List</a></li>
      <li class="breadcrumb-item active">Update Existing Job</li>
    </ol>
  </nav>
</div><!-- End Page Title -->
...
<section class="section">
  <div class="row">
      <div class="card">
        <div class="card-body">
          <h5 class="card-title">Edit Existing Job</h5>


<!-- Floating Labels Form -->
<form class="row g-3"  action ="jobsedit?rid=<?php echo e($jobs->jobs->id); ?>" method="post">
<?php echo csrf_field(); ?>
<div class="col-md-12">
    <div class="form-floating">
    <input type="text" class="form-control" placeholder="Job Title" value="<?php echo e($jobs->jobs->title); ?>" name="title" required>
...
<div class="col-md-6">
    <div class="form-floating">
    <input type="text" class="form-control" id="floatingLocation" placeholder="Job Location" value="<?php echo e($jobs->location); ?>" name="location" required>
...
<div class="col-md-6">
    <div class="form-floating">
    <input type="type" class="form-control" id="floatingSchedule" placeholder="Job Schedule" value="<?php echo e($jobs->schedule); ?>" name="schedule" required>
...
<div class="col-12">
    <div class="form-floating">
    <textarea class="form-control" placeholder="Job Responsibilities" id="floatingTextarea" style="height: 100px;" name="res" required><?php echo e($jobs->res); ?></textarea>
...
<div class="col-12">
    <div class="form-floating">
    <textarea class="form-control" placeholder="Job Remuneration" id="floatingTextarea" style="height: 100px;" name="rem" required><?php echo e($jobs->rem); ?></textarea>
...
<?php echo e(View:: make('footer')); ?><?php /**PATH C:\xampp\htdocs\final-project\resources\views/jobsedit.blade.php ENDPATH**/ ?>